...
function getSavedColumns() {
  if (localStorage.getItem('backlogItems')) {
    ...
    progressListArray = ['Building Portfolio', 'Going to the gym', 'Kickboxing', 'Finishing this course'];
    completeListArray = ['Being Cool', 'This Project'];
    onHoldListArray = ['Bad Habits'];
  }
};
